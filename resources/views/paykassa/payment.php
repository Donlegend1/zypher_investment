...
$secret_keys_and_config = [
    ...
    "merchant_password" =>  config('paykassa.merchant_password'),
    "api_id" => config('paykassa.api_id'),
    "api_password" => config('paykassa.api_password'),
    "config" => [
        "test_mode" =>config('paykassa.test_mode'),
    ],
];
