     ...
     @section('content')
        ...
        <section class="bg_img hero-section-2 left-bottom-lg-max" data-background="/images/about/hero-bg5.png">
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-xl-4 offset-xl-1">
                            ...
                            <div class="contact-content">
                                ...
                                <p>
                                    Do you have questions about payments or price plans? We have answers!
                                </p>
